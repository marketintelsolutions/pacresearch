...
export const services = [
  ...
  },
  {
    ...
    text: "At PAC Research, we understand the importance of data-driven decision-making in today's rapidly evolving business landscape. Our comprehensive Business Intelligence Services offer a wide range of solutions to help businesses extract maximum value from data. We understand that data is the backbone of modern businesses. Our services are designed to help businesses extract maximum value from their data and gain the insights they need to make informed decisions. Whether you are looking to optimize your operations, improve customer satisfaction, or gain a competitive edge, we have the expertise and experience to help you achieve your goals.  Our team of skilled analysts use the latest analytical methods to identify patterns, trends, and insights that can help businesses make informed decisions and gain a competitive advantage. Our analytics solutions help businesses gain a deep understanding of their customers, competitors, and market trends, enabling them to make data-driven decisions that drive growth and profitability. At PAC Research, we pride ourselves on our ability to offer customized solutions tailored to the unique needs of each client. Whether you are a small business or a large enterprise, our team of experts will work with you to develop a solution that meets your specific needs and budget.",
  },
  {
    icon: <SlPeople />,
    heading: "consulting",
